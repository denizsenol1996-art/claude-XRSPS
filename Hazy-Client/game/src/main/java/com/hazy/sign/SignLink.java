...
public final class SignLink implements Runnable {
    ...
    public static String findDataDir() {
        File f1 = new File(System.getProperty("user.home") + "/.hazy/");
        f1.mkdir();
        File f2 = new File(System.getProperty("user.home") + "/.hazy/data/");
        f2.mkdir();
        boolean exists = new File(System.getProperty("user.home") + "/.hazy/data/").exists();
        if(!exists) {
            File f = new File(System.getProperty("user.home") + "/.hazy/data/");
            f.mkdir();
        }
        return System.getProperty("user.home") + "/.hazy/data/";
    }
