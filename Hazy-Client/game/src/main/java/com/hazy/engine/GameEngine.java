package com.hazy.engine;

import com.hazy.Client;
import com.hazy.draw.ProducingGraphicsBuffer;
...
import com.hazy.engine.task.TaskHandler;
import com.hazy.engine.task.TaskUtils;
import com.hazy.engine.task.impl.MilliClock;
import com.hazy.engine.task.impl.NanoClock;
import com.hazy.util.Bounds;
...
public abstract class GameEngine extends Applet implements Runnable, WindowListener, RSGameEngine, FocusListener {
    ...
    public final void resizeCanvas() {
        ...
        if (container != null) {
            ...
            Client.rasterProvider = new ProducingGraphicsBuffer(canvasWidth, canvasHeight, canvas, hasDepth);
            if (container == frame) {
    ...
    protected final void startThread(int var1, int var2, int var3, int var4) {
        try {
            ...
            taskHandler.newThreadTask(this, Thread.MAX_PRIORITY);
        } catch (Exception ex) {
            ex.printStackTrace();
            error("crash");
        }
