...
public final class Tile extends Node implements RSTile {
    ...
    public Tile(int z, int x, int y){
        gameObjects = new InteractiveObject[5];
        tiledObjectMasks = new int[5];
        anInt1310 = z1AnInt1307 = z;
        anInt1308 = x;
        anInt1309 = y;
    }
    ...
    public final InteractiveObject[] gameObjects;
    ...
    @Override
    public int getFlags() {
      /*  for (int active = 0; active < this.gameObjectIndex; active++) {
            for (int index = active; index < this.gameObjectIndex; index++) {
