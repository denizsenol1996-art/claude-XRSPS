...
public class Settings {
    ...
    public void toggleVarbits() {
        Client.instance.toggleConfig(169, sound_state);
        Client.instance.toggleConfig(166, brightness);
        Client.instance.toggleConfig(289, profanityFilter ? 1 : 0);
        Client.instance.toggleConfig(207, cameraMovement ? 1 : 0);
        Client.instance.toggleConfig(290, loginLogoutNotification ? 1 : 0);
        Client.instance.toggleConfig(288, hidePrivateChat ? 1 : 0);
        Client.instance.toggleConfig(594, esc_close ? 1 : 0);
        Client.instance.toggleConfig(293, shiftClick ? 1 : 0);
        Client.instance.toggleConfig(427, acceptAid ? 1 : 0);
        Client.instance.toggleConfig(291, shift_pet_options ? 1 : 0);
        Client.instance.toggleConfig(170, mouseButtons ? 1 : 0);
        Client.instance.toggleConfig(294, zoomToggle ? 1 : 0);
        Client.instance.toggleConfig(171, chatEffects ? 1 : 0);
        Client.instance.toggleConfig(287, privateChat ? 1 : 0);
        Client.instance.toggleConfig(295, transparentSidePanel ? 1 : 0);
        Client.instance.toggleConfig(296, transparentChatbox ? 1 : 0);
        Client.instance.toggleConfig(297, sideStonesArrangement ? 1 : 0);
        Client.instance.toggleConfig(298, roofs ? 1 : 0);
        Client.instance.toggleConfig(299, orbs ? 1 : 0);
    }
    ...
    public void save() {
        ...
        try {
            ...
            writeLine("zoom_distance", Client.cameraZoom, bw);
