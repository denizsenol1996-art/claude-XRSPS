...
public class ClanChatSidebarWidget extends Widget {
    ...
    public static void editClan(AdvancedFont[] font) {
        ...
        addInputField(47828, 12, 0xFF981F, "", 117, 25, false, false);
        ...
        addInputField(47843, 30, 0xFF981F, "", 223, 20, false, false);
        addText(47844, "Limit:", font, 0, 0xFF981F, true, true);
        addInputField(47845, 3, 0xFF981F, "", 30, 25, false, false);
        addText(47846, "Req:", font, 0, 0xFF981F, true, true);
        addInputField(47847, 10, 0xFF981F, "", 60, 25, false, false);

        widget.totalChildren(65);
        ...
        widget.child(33, 47801, 51, 91);
        widget.child(34, 47812, 49, 132);
        widget.child(35, 47813, 46, 173);
        ...
        widget.child(44, 47821, 26, 210);
        widget.child(45, 47822, 46, 210);
        widget.child(46, 47823, 26, 230);
        widget.child(47, 47824, 46, 230);
        ...
        widget.child(59, 47842, 225, 75);
        widget.child(60, 47843, 255, 72);
        widget.child(61, 47844, 40, 286);
        widget.child(62, 47845, 60, 280);
        widget.child(63, 47846, 105, 286);
        widget.child(64, 47847, 118, 280);
    ...
    public static void clanChat(AdvancedFont[] font) {
        ...
        addText(33815, "0/500", font, 0, 0xFE9900, false, true);
        ...
        scrollInterface.scrollMax = 8000;
        int x = 7, y = 9;
        scrollInterface.totalChildren(505); // Correct total number of children
        ...
        for (frame = 0; frame < 500; frame++) {
            ...
            addHoverText(children, "", "", font, 0, 0xFFFFFF, false, true, 168);
            scrollInterface.child(frame, children, x, y);
            y += 15;
        }
        ...
        for (int i = 0; i < 5; i++) {
            addClickableText(start + i, names[i], "Join", font, 0, 16750623, false, true, 90);
            scrollInterface.child(frame + i, start + i, x - 10, y);
        }
    }
