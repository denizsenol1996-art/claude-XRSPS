...
public class BankWidget extends Widget {
    ...
    private static void bank_settings(AdvancedFont[] font) {
        ...
        addConfigButton(34000 + 16, 34000, 491, 641, Client.instance.setting.incinerator ? "Disable Incinerator" : "Enable Incinerator", 754, 0, OPTION_OK);
        addHoverText(34000 + 17, "Incinerator", "Incinerator", font, 1, 0xFE9624, true, true, 65, 0xffffff);
        
        addConfigButton(34000 + 18, 34000, 491, 641, Client.instance.setting.hide_equipment_button ? "Hide 'Deposit worn items' button" : "Show 'Deposit worn items' button", 755, 0, OPTION_OK);
        addHoverText(34000 + 19, "'Deposit worn items' button", "'Deposit worn items' button", font, 1, 0xFE9624, true, true, 155, 0xffffff);
        
        addConfigButton(34000 + 20, 34000, 491, 641, Client.instance.setting.hide_inventory_button ? "Hide 'Deposit inventory' button" : "Show 'Deposit inventory' button", 756, 0, OPTION_OK);
