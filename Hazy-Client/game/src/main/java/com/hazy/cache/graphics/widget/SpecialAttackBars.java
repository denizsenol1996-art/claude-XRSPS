...
import static com.hazy.util.ItemIdentifiers.GRANITE_MAUL_24225;
...
public enum SpecialAttackBars {
    ...
    //Melee
    ANCIENT_GODSWORD(26233, "Blood Sacrifice: The target will have eight ticks (4.8 seconds) to move at least five tiles away from the attacker or else take 25 damage and heal the attacker.", 50.0, 31353, 7699, 7711),

    OSMUMTENS_FANG(26219, "", 50.0, 31353, 7599, 7611),
    OSMUMTENS_FANG_OR(27246, "", 50.0, 31353, 7599, 7611),
    VOIDWAKER(27690, "", 50.0, 31353, 7599, 7611),
    URSINE_CHAINMACE(27660, "", 50.0, 31353, 7624, 7636),
    WEBWEAVER_BOW(27655, "", 50.0, 31353, 7549, 7561),
    ...
    ARMADYL_FROSTSWORD(30003, "The Judgement: Deal an attack that inflicts 37.5% more damage with double accuracy.", 50.0, 31353, 7699, 7711),
    ...
    FROST_CLAWS(30001, "Slice and Dice: Hit 4 times in quick succession, with great accuracy.", 50.0, 31384, 7800, 7812),
    ...
    ABYSSAL_TENTACLE_OR(26484,"Binding Tentacle: Bind your target for 5 seconds and increase the chance of them being poisoned.",50.0, 31448, 12323, 12335),
    ...
    SOULREAPER_AXE(28338, "Behead: which consumes any remaining Soul Stacks (rather than special attack energy). The special attack, for each Soul Stack, increases the player's accuracy and Strength by 6% and heals them by 8 Hitpoints, essentially regaining any lost health gaining Soul Stacks.", 25.0, 31416, 7499, 7511),
    ...
    public static final SpecialAttackBars[] VALUES = values();
