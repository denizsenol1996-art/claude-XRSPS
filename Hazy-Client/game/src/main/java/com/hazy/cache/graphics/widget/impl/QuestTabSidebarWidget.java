...
public class QuestTabSidebarWidget extends Widget {
    ...
    public static void unpackInfo(AdvancedFont[] font) {
        ...
        addHoverText(12661, "Open Our Website", "Go to HazyRealm.com", font, 1, 0xff9933, false, true, 150, 11, 0xFFBD7D);
        ...
        //Add string here and shift all ids by one hella work lol and reposition all the text too mkmk ill play with it later ty
        ...
        int intChild = 0;
        int intChild2 = 0;
        scrolls.totalChildren(43);//Dont forget to change child ids too other wise big errs  kk, y determines height just play with that like the others are done they all go down by exact numbers I think
