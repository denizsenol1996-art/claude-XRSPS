...
public class DropInterfaceWidget extends Widget {
    ...
    private static void dropInterface(AdvancedFont[] font) {
        ...
        addText(55155, "<col=ffff00>Note:</col> Drop rates reflect based off your drop rate bonus.", font, 0, 0xffffff, true, true);
        main.totalChildren(13);

        double yoff = 1.5;
        main.child(0, 55141, 6, (int) (2 - yoff));
        main.child(1,55143, 17, (int) (64 - yoff));
        main.child(2, 55146, 69, (int) (46 - yoff));

        main.child(3, 55147, 189, (int) (46 - yoff));
        main.child(4, 55148, 255, (int) (46 - yoff));
        main.child(5, 55149, 333, (int) (46 - yoff));
        main.child(6, 55150, 384, (int) (46 - yoff));
        main.child(7, 55151, 437, (int) (46 - yoff));
        main.child(8, 55153, 55 + 107, (int) (67 - yoff));
        main.child(9, 55152, 480, (int) (12 - yoff));
        main.child(10, 55200, 10, (int) (84 - yoff));
        main.child(11, 55154, 275, (int) (11 - yoff));
        main.child(12, 55155, 257, (int) (313 - yoff));
        ...
        for (int i = 0; i < 150; i++) {
            ...
            dropWidget.child(nameStart + i, 56700 + i, 50, nameY);
            nameY += 39;
        }
        ...
        for (int i = 0; i < 150; i++) {
            ...
            dropWidget.child(amountStart + i, 56850 + i, 173, amountY);
            amountY += 39;
        }
        ...
        for (int i = 0; i < 150; i++) {
            ...
            dropWidget.child(rateStart + i, 57000 + i, 225, rateY);
            rateY += 39;
        }
