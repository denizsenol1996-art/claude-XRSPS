...
public class ForgeWidget extends Widget {
    ...
    public static void unpack(AdvancedFont[] font) {
        ...
        mode.child(0, 69001, 60 - xoff, 47 - yoff);
        mode.child(1, 69002, 446 - xoff, 54 - yoff);

        mode.child(2, 69003, 285 - xoff, 56 - yoff);
        mode.child(3, 69005, 330 - xoff, 88 - yoff);

        mode.child(4, 69006, 313 - xoff, 255 - yoff);
        mode.child(5, 69007, 370 - xoff, 262 - yoff);

        mode.child(6, 69008, 340 - xoff, 189 - yoff);

        mode.child(7, 69009, 358 - xoff, 212 - yoff);

        mode.child(8, 69010, 69 - xoff, 85 - yoff);
        mode.child(9, 69011, 133 - xoff, 85 - yoff);
        mode.child(10, 69012, 196 - xoff, 85 - yoff);

        mode.child(11, 69013, 100 - xoff, 91 - 1 - yoff);
        mode.child(12, 69014, 163 - xoff, 91 - 1 - yoff);
        mode.child(13, 69015, 227 - xoff, 91 - 1 - yoff);
        mode.child(14, 69016, (int) (280 - 1.5 - xoff), 110 - yoff);
        mode.child(15, 69020, 70 - xoff, 110 - yoff);
