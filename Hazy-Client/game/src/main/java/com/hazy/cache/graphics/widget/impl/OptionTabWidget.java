...
import com.hazy.cache.graphics.widget.Slider;
...
public class OptionTabWidget extends Widget {
    ...
    private static void displaySettings(Widget display, AdvancedFont[] font) {
        ...
        slider(ZOOM_SLIDER, 143, 1133, 606, 615);
    ...
    private static void controlsSettings(Widget controls, AdvancedFont[] font) {
        ...
        controls.totalChildren(10);//i think maybe because client is in debug let me try to take offf
        int childNum = 0;
    ...
    private static void advancedWidget(AdvancedFont[] font) {
        ...
        String right_or_left = Client.instance.settings[ConfigUtility.CHATBOX_SCROLLBAR_ID] == 0 ? "right" : "left";
        ...
        addSprite(43011, 698);
        String panel = Client.instance.settings[ConfigUtility.REMAINING_XP_ID] == 1 ? "on" : "off";
        ...
        addSprite(43014, 701);
        String prayer_tooltips = Client.instance.settings[ConfigUtility.PRAYER_TOOLTIPS_ID] == 1 ? "on" : "off";
        ...
        addSprite(43017, 702);
        String special_bar_tooltips = Client.instance.settings[ConfigUtility.SPECIAL_ATTACK_BAR_TOOLTIPS_ID] == 1 ? "on" : "off";
        ...
        addSprite(43020, 697);
        String roof_removal = Client.instance.settings[ConfigUtility.ROOF_REMOVAL_ID] == 1 ? "on" : "off";
        ...
        addSprite(43023, 696);
        String data_orbs = Client.instance.settings[ConfigUtility.DATA_ORBS_ID] == 1 ? "on" : "off";
        ...
        if (Client.instance.settings[ConfigUtility.TRANSPARENT_CHAT_BOX_ID] == 0) {
        ...
        if (Client.instance.settings[ConfigUtility.CAN_BE_CLOSED_BY_HOTKEYS_ID] == 0) {
    ...
    public static void updateSettings() {
        if (Widget.cache[PLAYER_ATTACK_DROPDOWN] != null && Widget.cache[PLAYER_ATTACK_DROPDOWN].dropdown != null) {
            Widget.cache[PLAYER_ATTACK_DROPDOWN].dropdown.setSelected(Widget.cache[PLAYER_ATTACK_DROPDOWN].dropdown.getOptions()[Client.instance.setting.player_attack_priority]);
        }
        if (Widget.cache[NPC_ATTACK_DROPDOWN] != null && Widget.cache[NPC_ATTACK_DROPDOWN].dropdown != null) {
            Widget.cache[NPC_ATTACK_DROPDOWN].dropdown.setSelected(Widget.cache[NPC_ATTACK_DROPDOWN].dropdown.getOptions()[Client.instance.setting.npc_attack_priority]);
        }
    }
