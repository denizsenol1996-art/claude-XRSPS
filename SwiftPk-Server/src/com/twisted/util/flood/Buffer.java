package com.twisted.util.flood;
...
public final class Buffer {
    ...
    public void writeLong(long value) {
        try {
            ...
            throw new RuntimeException("14395, " + 5 + ", " + value + ", "
    ...
    public int method440() {
        currentPosition += 4;
        return ((payload[currentPosition - 3] & 0xFF) << 24) + ((payload[currentPosition - 4] & 0xFF) << 16) + ((payload[currentPosition - 1] & 0xFF) << 8) + (payload[currentPosition - 2] & 0xFF); //Used to be [- 2] now changed to [currentPosition - 2] may not be correct but this is unused anyway
    }
