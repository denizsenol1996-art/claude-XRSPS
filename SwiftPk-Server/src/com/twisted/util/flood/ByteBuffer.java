...
public final class ByteBuffer {
    private static final Logger logger = LogManager.getLogger(ByteBuffer.class);
    ...
    public void encryptRSAContent() {
        ...
        puts(encodedBuffer, encodedBuffer.length, 0);
    }
    ...
    public void puts(byte[] tmp, int len, int off) {
        for (int i = off; i < off + len; i++) {
