...
public class Packet {
    ...
    public int readSmart() {
        return buffer.getByte(buffer.readerIndex()) < 127 ? readByte() & 0xFF : (readShort() & 0xFFFF) - 32768;
    }
    ...
    public int readSignedSmart() {
        return buffer.getByte(buffer.readerIndex()) < 127 ? (readByte() & 0xFF) - 64 : (readShort() & 0xFFFF) - 49152;
    }
