package com.twisted.net.packet.interaction;
...
public final class PacketInteractionManager {
     ...
     */
    private static final ObjectList<PacketInteraction> interactions = new ObjectArrayList<>();
    ...
    private static void loadRecursive() throws IOException {
        ...
        Set<Class<?>> clazzes = classPath.getTopLevelClassesRecursive("com.twisted.game").stream().map(ClassPath.ClassInfo::load).collect(Collectors.toSet());
