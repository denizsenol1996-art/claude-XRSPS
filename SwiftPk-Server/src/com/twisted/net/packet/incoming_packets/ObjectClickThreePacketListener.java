...
import static com.twisted.net.packet.incoming_packets.ObjectClickOnePacketListener.pathToAndTrigger;
 ...
 */
public class ObjectClickThreePacketListener implements PacketListener {

    private static final Logger logger = LogManager.getLogger(ObjectClickThreePacketListener.class);
    ...
    public void handleMessage(Player player, Packet packet) {
        ...
        player.debugMessage("Object click3 " + String.format("objectId=%d, x=%d, y=%d", id, x, y));
