package com.twisted.net.security;
...
public final class IsaacRandom {
    ...
    @NotNull
    public static IsaacRandom DUMMY() {
        int[] seed = new int[4];
        seed[0] = (int) (Math.random() * 99999999D);
        seed[1] = (int) (Math.random() * 99999999D);
        seed[2] = (int) (Math.random() * 99999999D);
        seed[3] = (int) (Math.random() * 99999999D);
        return new IsaacRandom(seed);
    }
}
