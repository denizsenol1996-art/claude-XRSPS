package com.twisted.game.world.route.routes;
...
public class ProjectileRoute {
    ...
    public static boolean allow(Mob entity, Mob target) {
        return allow(entity.getAbsX(), entity.getAbsY(), entity.getZ(), entity.getSize(), target.getAbsX(), target.getAbsY(), target.getSize());
    }

    public static boolean allow(Mob entity, Tile dest) {
        return allow(entity.getAbsX(), entity.getAbsY(), entity.getZ(), entity.getSize(), dest.getX(), dest.getY(), 1);
    }

    public static boolean allow(Mob entity, int destX, int destY) {
        return allow(entity.getAbsX(), entity.getAbsY(), entity.getZ(), entity.getSize(), destX, destY, 1);
    }
