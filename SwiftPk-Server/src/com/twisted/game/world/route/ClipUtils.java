...
public class ClipUtils {
    ...
    public static final ClipUtils SWIM = new ClipUtils() {
        ...
        public int getAbs(int absX, int absY, int z) {
            ...
            return (clipping == 0 || (clipping & RouteFinder.UNMOVABLE_MASK) == 0) ? RouteFinder.UNMOVABLE_MASK : (clipping & ~RouteFinder.UNMOVABLE_MASK);
        }
    };
    ...
    public static void addClipping(int x, int y, int z, int mask, boolean projectile) {
        if(projectile)
            RegionManager.addClippingProj(x, y, z, mask);
        else
            RegionManager.addClipping(x, y, z, mask);
    }
    ...
    public static void removeClipping(int x, int y, int z, int mask, boolean projectile) {
        if(projectile)
            RegionManager.removeClippingProj(x, y, z, mask);
        else
            RegionManager.removeClipping(x, y, z, mask);
    }
