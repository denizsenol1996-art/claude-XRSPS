package com.twisted.game.world.entity.mob.npc.bots.impl;
...
public class RuneMainBot extends NPCBotHandler implements CombatMethod {
     ...
     * The default npc.
     */
    private static final int DEFAULT_BOT_ID = NPCBotHandler.RUNE_MAIN_BOT_ID;

    /**
     * The npc which has
     * a special attack weapon equipped.
     */
    private static final int SPEC_BOT_ID = NPCBotHandler.RUNE_MAIN_BOT_ID + 1;
    ...
    public void process() {
        ...
        if (CombatFactory.inCombat(npc)) {
            ...
            if (!npc.isSpecialActivated()) {
                ...
                //System.out.println("Let's transform");
