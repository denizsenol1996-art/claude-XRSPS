...
public class PetVarbits {
    ...
    public static final int UNLOCKED_PET_DOPPELGANGER = 12042;
    public static final int UNLOCKED_PET_GRAARDOR_BLACK = 4328;
    public static final int UNLOCKED_PET_KRIL_BLACK = 4329;
    public static final int UNLOCKED_PET_ZILYANA_WHITE = 4330;
    public static final int UNLOCKED_PET_KREE_WHITE = 4331;
    public static final int UNLOCKED_PET_BABY_SQUIRT = 4332;
    public static final int UNLOCKED_PET_GRIM_REAPER = 4333;
    public static final int UNLOCKED_PET_BABY_DARK_BEAST = 4334;
    public static final int UNLOCKED_PET_BABY_ABYSSAL_DEMON = 4335;
    public static final int UNLOCKED_PET_ZOMBIES_CHAMPION = 4336;
    public static final int UNLOCKED_PET_BARRELCHEST = 4337;
    ...
    public static final int UNLOCKED_PET_NIFFLER = 4346;
    ...
    public static final int UNLOCK_PET_FAWKES = 5363;
    ...
    public static final int UNLOCKED_MUSPAH = 12003;

    public static final int UNLOCKED_PET_YOSHI = 12004;
    public static final int UNLOCKED_PET_CURSED_ELEMENT = 12005;
    public static final int UNLOCKED_THE_ONE_ABOVE_ALL = 12006;
}
