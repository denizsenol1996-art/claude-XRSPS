...
import com.twisted.db.transactions.BanPlayerDatabaseTransaction;
    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        if(GameServer.properties().punishmentsToLocalFile) {
            ...
            if (playerToBan.isPresent()) {
                ...
                Utils.sendDiscordInfoLog(player, "Player " + username + " was banned by " + player.getUsername(), "sanctions");
            } else {
                //offline
                    ...
                    try {
                        if (PlayerSave.loadOfflineWithoutPassword(offlinePlayer)) {
                            GameEngine.getInstance().addSyncTask(() -> {
                                ...
                                Utils.sendDiscordInfoLog(player, "Player " + offlinePlayer.getUsername() + " was offline banned by " + player.getUsername(), "sanctions");
                            });
                        } else {
            ...
            player.setEnterSyntax(new EnterSyntax() {
                ...
                public void handleSyntax(Player player, String input) {
                    ...
                    if (plr.isPresent()) {
                        ...
                        Utils.sendDiscordInfoLog(player, "Player " + username + " was banned by " + player.getUsername() + " until " + unbanTimestamp + " for: " + input, "sanctions");
                    } else {
