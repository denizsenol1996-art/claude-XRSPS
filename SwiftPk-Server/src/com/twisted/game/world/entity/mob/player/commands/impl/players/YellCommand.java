    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        if(ignoreStaffColour) {
            switch (player.getPlayerRights()) {
                ...
                case ADMINISTRATOR, HARDCORE_IRON_MAN, MANAGER, OWNER -> nameColour = Color.RED.tag();
        ...
        World.getWorld().sendWorldMessage("<shad=1>"+nameColour+"["+playerIcon+"</img>"+memberIcon+"</img>"+username+"]</col></shad>: <shad=2><col="+yellColour+">"+formatYellMessage);
