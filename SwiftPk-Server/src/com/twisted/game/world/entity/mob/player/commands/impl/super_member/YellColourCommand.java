package com.twisted.game.world.entity.mob.player.commands.impl.super_member;
...
public class YellColourCommand implements Command {
    ...
    public void execute(Player player, String command, String[] parts) {
        if(!player.getMemberRights().isSaphireOrGreater(player) && !player.getPlayerRights().isDeveloperOrGreater(player)) {
