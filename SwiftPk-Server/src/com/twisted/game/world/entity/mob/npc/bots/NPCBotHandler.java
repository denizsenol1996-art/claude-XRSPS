package com.twisted.game.world.entity.mob.npc.bots;
...
import com.twisted.game.world.entity.mob.npc.bots.impl.*;
import com.twisted.game.world.entity.mob.player.Player;
import com.twisted.util.SecondsTimer;
import com.twisted.util.Stopwatch;
...
public abstract class NPCBotHandler {
    ...
    public void eat(FoodConsumable.Food food, int minDelayMs) {
        ...
        if (eatDelay.elapsed(minDelayMs)) {
            ...
            npc.getTimerRepository().extendOrRegister(TimerKey.COMBAT_ATTACK, 2);
