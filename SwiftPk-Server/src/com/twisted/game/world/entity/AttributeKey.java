...
public enum AttributeKey {
     ...
     */
    SACK_OF_PRESENTS_LIST,

    RISKZONE_POINTS("riskzone_points", AttribType.INTEGER),

    EVENT_MONSTERS_KILLED("event_monsters_killed", AttribType.INTEGER),
    /**
    ...
    SLAYER_LOG_CLAIMED,
    ICE_DEMON_LOG_CLAIMED,
    ELVARG_LOG_CLAIMED,
    LAVA_BEASTS_LOG_CLAIMED,
    EL_FUEGO_LOG_CLAIMED,
    DERANGED_ARCHAEOLOGIST_LOG_CLAIMED,
    ...
    STARTER_BOX_DARK_LORD_CLAIMED("starter_box_dark_lord_claimed", AttribType.BOOLEAN),//sbox
    ...
    E_GLOVES_ATTEMTPS("e_gloves_attempts", AttribType.INTEGER),
    E_HELM_ATTEMTPS("e_helm_attempts", AttribType.INTEGER),

    DARK_ELDER_MAUL_ATTEMPTS("dark_elder_maul_attempts", AttribType.INTEGER),

    ELDER_ICE_MAUL_ATTEMPTS("elder_ice_maul_attempts", AttribType.INTEGER),
    ...
    RESET_ACCOUNT("reset_account", AttribType.BOOLEAN),


    LOOTING_BAG_UPGRADE("looting_bag_upgrade", AttribType.BOOLEAN),

    CRYSTAL_KEYS_OPENED("crystal_keys_opened", AttribType.INTEGER),
    WILDY_KEYS_OPENED("wildy_keys_opened", AttribType.INTEGER),
    MOLTEN_KEYS_OPENED("molten_keys_opened", AttribType.INTEGER),
    ENCHANTED_KEYS_R_OPENED("enchanted_keys_r_opened", AttribType.INTEGER),
    ENCHANTED_KEYS_P_OPENED("enchanted_keys_p_opened", AttribType.INTEGER),
    ...
    FAWKEYS_ATTEMPTS("fawkeys_attempts", AttribType.INTEGER),
    MENDING_ATTEMPTS("mending_attempts", AttribType.INTEGER),
    ZIFFLER_ATTEMPTS("ziffler_attempts", AttribType.INTEGER),
    RUNE_POUCH_I_ATTEMPTS("rune_pouch_i_attempts", AttribType.INTEGER),

    IMBUED_FROST_CAPE_ATTEMPTS("imbued_frost_cape_attempts", AttribType.INTEGER),

    LOOTING_BAG_ATTEMPTS("looting_bag_attempts", AttribType.INTEGER),//updatelootingbagtoday

    MYTHICAL_MAX_CAPE_ATTEMPTS("mythical_max_cape_attempts", AttribType.INTEGER),//UPDATET2

    DRAGON_CLAWS_OR_ATTEMPTS("dragon_claws_or_attempts", AttribType.INTEGER),

    DRAGON_HCB_ATTEMPTS("dragon_hcb_attempts", AttribType.INTEGER),
    ...
    ENCHANTED_TOTEMIC_HELM_ATTEMPS("enchanted_totemic_helm_attempts", AttribType.INTEGER),

    ENCHANTED_TOTEMIC_BODY_ATTEMPS("enchanted_totemic_body_attempts", AttribType.INTEGER),

    ENCHANTED_TOTEMIC_LEGS_ATTEMPS("enchanted_totemic_body_attempts", AttribType.INTEGER),
    ...
    GRAND_KEY_ATTEMPTS("grand_key_attempts", AttribType.INTEGER),

    LARRANS_KEY_II_ATTEMPTS("larrans_key_II_attempts", AttribType.INTEGER),
    ETHEREAL_SCYTHE_ATTEMPTS("Ethereal_Scythe_attempts", AttribType.INTEGER),
    ...
    ANCIENT_VESTA_LONGSWORD_ATTEMPTS("ancient_vesta_longsword_attempts", AttribType.INTEGER),
    WEBWEAVER_ATTEMPTS("Webweaver_attempts", AttribType.INTEGER),
    URSINE_ATTEMPTS("Ursine_attempts", AttribType.INTEGER),
    MENDING_SWORD_OF_GRYFFINDOR_ATTEMPTS("Sword_of_gryffindor_attempts", AttribType.INTEGER),
    MENDING_GHRAZI_RAPIER_ATTEMPTS("mending_ghrazi_rapier_attempts", AttribType.INTEGER),
    ANCIENT_STATIUS_WARHAMMER_ATTEMPTS("ancient_statius_warhammer_attempts", AttribType.INTEGER),
    ...
    OSMUMTENS_FANG_OR_ATTEMPTS("osmumten's fang or", AttribType.INTEGER),
    ...
    GOT_RARE("got_rare", AttribType.BOOLEAN),
    ...
    SELECET("select", AttribType.INTEGER),//lamp
    ...
    TICKET_RUNS_CHALLENGE_COMPLETED("Ticket_runs_challenge", AttribType.INTEGER),
    ...
    ICE_DEMONS_KILLED("Ice_demons_killed", AttribType.INTEGER),
    ELVARGS_KILLED("Elvargs_killed", AttribType.INTEGER),
    ...
    SEREN_KILLED("seren_killed", AttribType.INTEGER),
    ...
    VOTEBOSS_MYSTERY_BOXES_OPENED("voteboss_mystery_boxes_opened", AttribType.INTEGER),//updatevoteboss
    AFKSTALL_REWARD_CLAIMED_OPENED("afkstall_reward_claimed_opened", AttribType.INTEGER),
    ...
    REVENANT_MYSTERY_BOXES_OPENED("revenant_mystery_boxes_opened", AttribType.INTEGER),
    ...
    BONDS_CASKET_OPENED("bond_casket_opened", AttribType.INTEGER),
    ...
    KILLING_BLOW_HIT, RECENT_LISTING_RESULTS, BUY_LISTING_RESULTS, DONATION_BOSS_KILLED, LAVA_BEASTS_KILLED, NEX_KILLED, MENDING_KILLED, GRIM_KILLED, DERANGED_ARCHAEOLOGIST_KILLED, EL_FUEGO_KILLED, COX_KILLS, AFK_THIEVING, RUINOUS_PRAYERS, GRANDMASTER_CURSE, ETHEREAL_REVENANTS_COMPLETED, ETHEREAL_REVENANTS_LOG_CLAIMED,
    SIGIL_OF_FORTIFICATION, FORMIDABLE_FIGHTER, CONSISTENCY,
    METICULOUS_MAGE, DEFT_STRIKES, RUTHLESS_RANGER, MENACING_MAGE,
    FERAL_FIGHTER, FERAL_FIGHTER_ATTACKS_SPEED, MENACING_CURSE,
    RUTHLESS_CRIPPLE, TOTAL_SIGILS_ACTIVATED, SIGIL_OF_ALCHEMANIAC,
    ALCHEMANIAC_BOOST, DEVOTION, SIGIL_OF_DEVOTION, SIGIL_OF_EXAGGERATION,
    EXAGGERATION_BOOST, INFERNAL_SMITH, SIGIL_OF_INFERNAL_SMITH,
    RECALL_ATTUNE_ACTIVE("last_saved_type", AttribType.BOOLEAN),
    SIGIL_OF_LAST_RECALL, SIGIL_OF_REMOTE_STORAGE, REMOTE_STORAGE,
    SIGIL_OF_STAMINA, SIGIL_OF_THE_NINJA, RESISTANCE, PRECISION, NINJA,
    TITANIUM, BLEED, MARK_OF_DARKNESS, REFERRALS_CLAIMED, TELEBLOCKED_BY,
    DIAMOND_MYSTERY_BOX_OPENED("diamond_mystery_box_opened",AttribType.INTEGER),
    DRAGONSTONE_MYSTERY_BOXES_OPENED("dragonstone_mystery_box_opened",AttribType.INTEGER),
    EMERALD_MYSTERY_BOX_OPENED("emerald_mystery_box_opened",AttribType.INTEGER),
    ONYX_MYSTERY_BOXES_OPENED("onyx_mystery_box_opened",AttribType.INTEGER),
    RUBY_MYSTERY_BOX_OPENED("ruby_mystery_box_opened",AttribType.INTEGER),
    SAPPHIRE_MYSTERY_BOX("sapphire_mystery_box_opened",AttribType.INTEGER),


    ATTACK_PRESITGE("attack_prestige",AttribType.INTEGER),
    STRENGTH_PRESTIGE("strength_prestige",AttribType.INTEGER),
    DEFENCE_PRESTIGE("defence_prestige",AttribType.INTEGER),
    RANGED_PRESTIGE("ranged_prestige",AttribType.INTEGER),
    PRAYER_PRESTIGE("prayer_prestige",AttribType.INTEGER),
    MAGIC_PRESTIGE("magic_prestige",AttribType.INTEGER),
    HITPOINTS_PRESTIGE("hitpoints_prestige",AttribType.INTEGER),
    SLAYER_PRESTIGE("slayer_prestige",AttribType.INTEGER),
    RUNECRAFTING_PRESTIGE("runecrafting_prestige",AttribType.INTEGER),
    AGILITY_PRESTIGE("agility_prestige",AttribType.INTEGER),
    HERBLORE_PRESTIGE("herblore_prestige",AttribType.INTEGER),
    THIEVING_PRESTIGE("thieving_prestige",AttribType.INTEGER),
    CRAFTING_PRESTIGE("crafting_prestige",AttribType.INTEGER),
    FLETCHING_PRESTIGE("fletching_prestige",AttribType.INTEGER),
    HUNTER_PRESTIGE("hunter_prestige",AttribType.INTEGER),
    MINING_PRESTIGE("mining_prestige",AttribType.INTEGER),
    SMITHING_PRESTIGE("smithing_prestige",AttribType.INTEGER),
    FISHING_PRESTIGE("fishing_prestige",AttribType.INTEGER),
    COOKING_PRESTIGE("cooking_prestige",AttribType.INTEGER),
    FIREMAKING_PRESTIGE("firemaking_prestige",AttribType.INTEGER),
    WOODCUTTING_PRESTIGE("woodcutting_prestige",AttribType.INTEGER);
    ...
    AttributeKey(AttribType attribType) {
        saveName = this.name();
