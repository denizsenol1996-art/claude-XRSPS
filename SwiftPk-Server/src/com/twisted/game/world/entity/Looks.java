...
public class Looks {
    ...
    public void transmog(int id) {
        ...
        if (id != -1) {
            ...
            renderpairOverride = new int[]{def.idleAnimation, def.walkAnimation, def.walkAnimation, def.render5, def.render6, def.render7, def.runAnimation};
        }
        player.looks().renderData(renderpairOverride);
    }
