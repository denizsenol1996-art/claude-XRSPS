...
import static com.twisted.game.content.items.combine.ElderWand.*;
import static com.twisted.util.CustomItemIdentifiers.TOXIC_STAFF_OF_THE_DEAD_C;
...
public enum CombatSpells {
    ...
    WATER_WAVE(new CombatSpell() {
        ...
        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(163, 80));
        }
    ...
    ENTANGLE(new CombatEffectSpell() {
        ...
        @Override
        public void spellEffect(Mob cast, Mob castOn, Hit hit) {
            cast.freeze(25, castOn); // 15 second freeze timer
        }
    ...
    TELEBLOCK(new CombatEffectSpell() {
        ...
        public boolean canCast(Player player, Mob target, boolean delete) {
            if (target.getTimerRepository().has(TimerKey.TELEBLOCK) || target.getTimerRepository().has(TimerKey.SPECIAL_TELEBLOCK) || target.getTimerRepository().has(TimerKey.TELEBLOCK_IMMUNITY)) {
        ...
        public void spellEffect(Mob cast, Mob castOn, Hit hit) {
            if (hit.isAccurate()) {
                if (cast instanceof Player player && castOn instanceof Player castOnPlayer) {
                    player.currentTeleblockedPlayers.add(castOnPlayer);
                }
            }
        }
    ...
    BLOOD_RUSH(new CombatEffectSpell() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Mob cast, Mob castOn, int dist) {
            return ancient(cast, castOn, dist, 371);
        }
    ...
    TUMEKENS_SPELL(new CombatSpell() {
        @Override
        public String name() {
        ...
        @Override
        public Optional<Animation> castAnimation() {
            return Optional.of(new Animation(9493));
        }

        @Override
        public Optional<Projectile> castProjectile(Mob cast, Mob castOn, int dist) {
            return modern(cast, castOn, dist, 2126); //9 *
        }

        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(2127, 0));
        }
        ...
        @Override
        public Optional<Graphic> startGraphic() {
            return Optional.of(new Graphic(2125, 80));
        }
    ...
    THAMMARON_SCEPTRE(new CombatSpell() {
        @Override
        public String name() {
        ...
        @Override
        public Optional<Projectile> castProjectile(Mob cast, Mob castOn) {
            return Optional.of(new Projectile(cast, castOn, 2340, 0, 40, 30, 23, 0));
        }
        ...
        @Override
        public Optional<Graphic> endGraphic() {
            return Optional.of(new Graphic(78, 50, 0));
        }
