package com.twisted.game.content.presets;
...
import static com.twisted.game.content.items.combine.ElderWand.CRUCIATUS_CURSE_SPELL;
...
public class PresetManager {
    ...
    public static final int[] ILLEGAL_ITEMS = new int[]{
        ...
        BLOOD_MONEY,
        BLOODY_TOKEN,
        CustomItemIdentifiers. HAZY_COINS,
    ...
    public void load(final Presetable preset) {
        ...
        if (!player.tile().inSafeZone() && !WildernessArea.inDiamondZone(player.tile()) && player.tile().region() != 11563) {//done1
