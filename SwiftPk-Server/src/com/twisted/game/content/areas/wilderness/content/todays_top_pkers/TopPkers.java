package com.twisted.game.content.areas.wilderness.content.todays_top_pkers;
...
public final class TopPkers {
    ...
    public void announce() {
        ...
        for (int i = 0; i < ANNOUNCEMENT_AMOUNT; i++) {
            ...
            if (entry != null) {
                var reward = position == 1 ? new Item(PRESENT_MYSTERY_BOX) : position == 2 ? new Item(PRESENT_MYSTERY_BOX) : new Item(PRESENT_MYSTERY_BOX);
