...
import static com.twisted.util.ItemIdentifiers.COINS_995;
import static com.twisted.util.NpcIdentifiers.PILES;
import static com.twisted.util.NpcIdentifiers.ROCKS_6601;
import static com.twisted.util.ObjectIdentifiers.GATE_26760;

public class ResourceArena extends PacketInteraction {//update27.4
    ...
    private void swap(Player player, int original, int result) {
        ...
        player.getDialogueManager().start(new Dialogue() {
            ...
            protected void start(Object... parameters) {
                send(DialogueType.OPTION, "Banknote "+player.inventory().count(original) + " "+new Item(original).name(), "Yes ", "Cancel");
                setPhase(0);
            }
