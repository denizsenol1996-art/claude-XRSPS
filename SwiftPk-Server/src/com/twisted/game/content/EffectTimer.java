...
public enum EffectTimer {
    ...
    DOUBLE_EXP(1771),
    DROP_RATE_PERK(1900),//up00
    DOUBLE_SLAYER_PERK(1901),//up00
    DOUBLE_EXP_PERK(1902)//up00
    ;
    ...
    public static void clearTimers(Player player) {
        player.getPacketSender().sendEffectTimer(0, EffectTimer.VENGEANCE).
            ...
            sendEffectTimer(0, DROP_RATE_PERK).//up00
            sendEffectTimer(0, DOUBLE_SLAYER_PERK).//up00
            sendEffectTimer(0, DOUBLE_EXP_PERK);//up00
    }
