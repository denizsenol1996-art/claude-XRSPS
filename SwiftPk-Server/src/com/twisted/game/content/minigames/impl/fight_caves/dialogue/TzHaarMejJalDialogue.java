package com.twisted.game.content.minigames.impl.fight_caves.dialogue;
...
public class TzHaarMejJalDialogue extends Dialogue {
    ...
    public static void unlockJad(Player player) {
        if (!PetAI.hasUnlocked(player, Pet.TZREK_JAD)) {
            ...
            World.getWorld().sendWorldMessage("<img=1875> " + player.getUsername() + " has unlocked the pet: <col="+Color.HOTPINK.getColorValue()+">" + new Item(Pet.TZREK_JAD.item).name()+ "</col>.");
        } else {
