package com.twisted.game.content.teleport.obelisk;
        ...
        Chain.bound(null).runFn(11, () -> {
            ...
            World.getWorld().getPlayers().forEach(p -> {
                ...
                if (plrx >= x - 1 && plrx <= x + 1 && plry >= y - 1 && plry <= y + 1) {
                    ...
                    } else if (p.getTimerRepository().has(TimerKey.TELEBLOCK) || p.getTimerRepository().has(TimerKey.SPECIAL_TELEBLOCK)) {
