package com.twisted.game.content.treasure;
...
public class Rewards {
        ...
        if (World.getWorld().rollDie(bloodhound ? 1 : 2, 1)) {
            ...
            if (reward != null) {
                ...
                if (reward.reward.getValue() >= 30000 && !player.getUsername().equalsIgnoreCase("Box test"))
                    World.getWorld().sendWorldMessage("<img=1875><col=0052cc>" + player.getUsername() + " has just received <col=" + Color.HOTPINK.getColorValue() + ">" + Utils.getAOrAn(reward.reward.name()) + " " + reward.reward.name() + " <col=0052cc>from a master casket!");
            }
        }
    }
    ...
    public enum StandardTable {
        ...
        //ICE_ARROWS(85.0, new Item(ItemIdentifiers.ICE_ARROWS, 1_000)),//wupdate
        EARTH_ARROWS(80.0, new Item(CustomItemIdentifiers.EARTH_ARROWS, 1_000)),
        // FIRE_ARROWS(75.0, new Item(CustomItemIdentifiers.FIRE_ARROWS, 1_000)),//wupdate
