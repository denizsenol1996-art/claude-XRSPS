...
public class EmeraldMysteryBox implements CollectionListener {
    @Override
    ...
    @Override
    public String name() {
        return "Emerald Mystery Box";
    }

    @Override
    public int id() {
        return CustomItemIdentifiers.EMERALD_MYSTERY_BOX;
    }
    ...
    public AttributeKey key() {
        return AttributeKey.EMERALD_MYSTERY_BOX_OPENED;
    }
