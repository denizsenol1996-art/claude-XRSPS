...
public class SapphireMysteryBox implements CollectionListener {
    @Override
    ...
    @Override
    public String name() {
        return "Sapphire Mystery Box";
    }

    @Override
    public int id() {
        return CustomItemIdentifiers.SAPPHIRE_MYSTERY_BOX;
    }
    ...
    public AttributeKey key() {
        return AttributeKey.SAPPHIRE_MYSTERY_BOX;
    }
