...
public class DragonstoneMysteryBox implements CollectionListener {
    @Override
    ...
    @Override
    public String name() {
        return "Dragonstone Mystery Box";
    }

    @Override
    public int id() {
        return CustomItemIdentifiers.DRAGONSTONE_MYSTERY_BOX;
    }
    ...
    public AttributeKey key() {
        return AttributeKey.DRAGONSTONE_MYSTERY_BOXES_OPENED;
    }
