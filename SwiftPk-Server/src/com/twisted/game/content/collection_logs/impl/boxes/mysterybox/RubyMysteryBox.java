...
public class RubyMysteryBox implements CollectionListener {
    @Override
    ...
    @Override
    public String name() {
        return "Ruby Mystery Box";
    }

    @Override
    public int id() {
        return CustomItemIdentifiers.RUBY_MYSTERY_BOX;
    }
    ...
    public AttributeKey key() {
        return AttributeKey.RUBY_MYSTERY_BOX_OPENED;
    }
