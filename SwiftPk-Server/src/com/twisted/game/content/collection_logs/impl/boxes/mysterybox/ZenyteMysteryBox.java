...
public class ZenyteMysteryBox implements CollectionListener {
    @Override
    public MysteryBoxItem[] rewards() {
        return new MysteryBoxItem[]{
            ...
            new MysteryBoxItem(CustomItemIdentifiers.DRAGON_COMPANION, 40, -1, true),
            new MysteryBoxItem(ItemIdentifiers.ENCHANTED_SALAZAR_LOCKET, 2, -1, true),
            new MysteryBoxItem(CustomItemIdentifiers.E_TOTEMIC_HELMET, 40, -1, true),
            new MysteryBoxItem(CustomItemIdentifiers.E_TOTEMIC_PLATEBODY, 40, -1, true),
            new MysteryBoxItem(CustomItemIdentifiers.E_TOTEMIC_PLATELEGS, 40, -1, true),
    ...
    @Override
    public String name() {
        return "Zenyte Mystery Box";
    }

    @Override
    public int id() {
        return CustomItemIdentifiers.ZENYTE_MYSTERY_BOX;
    }
    ...
    public AttributeKey key() {
        return AttributeKey.ZENYTE_MYSTERY_BOXES_OPENED;
    }
