package com.twisted.game.content.items.equipment.max_cape.dialogue;
...
import static com.twisted.game.content.items.equipment.max_cape.MaxCape.HOOD;
import static com.twisted.game.content.items.equipment.max_cape.MaxCape.NORMAL_MAXCAPE;
...
public class CombineDialogue extends Dialogue {
    ...
    private int[] comboOf(int id) {
        ...
        } else if (id == MaxCape.FROST) {
            return new int[]{MaxCape.FROST_IMBUED_MAX_CAPE, MaxCape.FROST_IMBUED_MAX_HOOD};
        }
