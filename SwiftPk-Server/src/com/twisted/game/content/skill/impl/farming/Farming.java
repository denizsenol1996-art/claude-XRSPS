...
import com.twisted.game.content.skill.impl.farming.patch.Allotments;
import com.twisted.game.content.skill.impl.farming.patch.Farmbit;
import com.twisted.game.content.skill.impl.farming.patch.Flowers;
import com.twisted.game.content.skill.impl.farming.patch.Herbs;
...
public class Farming extends PacketInteraction {
    ...
    public static void addTimer(Player player, TimerKey timerKey, int time) { //time = 1000
        player.getTimerRepository().addOrSet(timerKey,time / 2);
    }

    public static void setTimer(Player player, TimerKey timerKey, int time) { //time = 1000
        player.getTimerRepository().register(timerKey, time / 2);
    }
