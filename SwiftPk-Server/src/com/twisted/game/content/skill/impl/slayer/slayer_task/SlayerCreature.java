package com.twisted.game.content.skill.impl.slayer.slayer_task;
...
public enum SlayerCreature {
    ...
    SCORPION(7, 1, 7,true,false, new Tile(3232, 3940), NpcIdentifiers.SCORPION, NpcIdentifiers.SCORPION_2480, NpcIdentifiers.SCORPION_3024, NpcIdentifiers.SCORPION_5242, NpcIdentifiers.SCORPIA, NpcIdentifiers.SCORPIAS_OFFSPRING, CustomNpcIdentifiers.SKORPIOS),
    ...
    BEARS(13, 1, 13,true,false, new Tile(3098, 3603), NpcIdentifiers.GRIZZLY_BEAR, NpcIdentifiers.BLACK_BEAR, NpcIdentifiers.BEAR_CUB, NpcIdentifiers.BEAR_CUB_3909, NpcIdentifiers.BEAR_CUB_9199, NpcIdentifiers.GRIZZLY_BEAR_CUB_3425, NpcIdentifiers.GRIZZLY_BEAR_3423, NpcIdentifiers.GRIZZLY_BEAR_CUB, NpcIdentifiers.CALLISTO, NpcIdentifiers.CALLISTO_6609),
    HILL_GIANTS(14, 1, 25,true,false, new Tile(3300, 3646), NpcIdentifiers.HILL_GIANT, NpcIdentifiers.HILL_GIANT_2099, NpcIdentifiers.HILL_GIANT_2100, NpcIdentifiers.HILL_GIANT_2101, NpcIdentifiers.HILL_GIANT_2102, NpcIdentifiers.HILL_GIANT_2103, NpcIdentifiers.HILL_GIANT_7261),
    ICE_GIANT(15, 1, 50, true,false, new Tile(2950, 3902), NpcIdentifiers.ICE_GIANT, NpcIdentifiers.ICE_GIANT_2086, NpcIdentifiers.ICE_GIANT_2087, NpcIdentifiers.ICE_GIANT_2088, NpcIdentifiers.ICE_GIANT_2089, NpcIdentifiers.ICE_GIANT_7878, NpcIdentifiers.ICE_GIANT_7879, NpcIdentifiers.ICE_GIANT_7880),
    FIRE_GIANTS(16, 1, 65,true,false, new Tile(3043, 10342), NpcIdentifiers.FIRE_GIANT, NpcIdentifiers.FIRE_GIANT_2076, NpcIdentifiers.FIRE_GIANT_2077, NpcIdentifiers.FIRE_GIANT_2078, NpcIdentifiers.FIRE_GIANT_2079, NpcIdentifiers.FIRE_GIANT_2080, NpcIdentifiers.FIRE_GIANT_2081, NpcIdentifiers.FIRE_GIANT_2082, NpcIdentifiers.FIRE_GIANT_2083, NpcIdentifiers.FIRE_GIANT_2084, NpcIdentifiers.FIRE_GIANT_7251, NpcIdentifiers.FIRE_GIANT_7252),
    MOSS_GIANT(17, 1, 40,true,false, new Tile(3147, 3825), NpcIdentifiers.MOSS_GIANT, NpcIdentifiers.MOSS_GIANT_2091, NpcIdentifiers.MOSS_GIANT_2092, NpcIdentifiers.MOSS_GIANT_2093, NpcIdentifiers.MOSS_GIANT_3851, NpcIdentifiers.MOSS_GIANT_3852, NpcIdentifiers.MOSS_GIANT_7262, NpcIdentifiers.MOSS_GIANT_8736),
    ...
    ICE_WARRIOR(19, 1, 45,true,false, new Tile(2950, 3902), NpcIdentifiers.ICE_WARRIOR, NpcIdentifiers.ICE_WARRIOR_2842, NpcIdentifiers.ICE_WARRIOR_2851),
    ...
    BLACK_DRAGONS(27, 1, 3, true,false,new Tile(3222, 10200, 0), NpcIdentifiers.BLACK_DRAGON, NpcIdentifiers.BLACK_DRAGON_253, NpcIdentifiers.BLACK_DRAGON_254, NpcIdentifiers.BLACK_DRAGON_255, NpcIdentifiers.BLACK_DRAGON_256, NpcIdentifiers.BLACK_DRAGON_257, NpcIdentifiers.BLACK_DRAGON_258, NpcIdentifiers.BLACK_DRAGON_259, NpcIdentifiers.BLACK_DRAGON_7861, NpcIdentifiers.BLACK_DRAGON_7862, NpcIdentifiers.BLACK_DRAGON_7863, NpcIdentifiers.BLACK_DRAGON_8084, NpcIdentifiers.BLACK_DRAGON_8085, NpcIdentifiers.BRUTAL_BLACK_DRAGON, NpcIdentifiers.BRUTAL_BLACK_DRAGON_8092, NpcIdentifiers.BRUTAL_BLACK_DRAGON_8092, NpcIdentifiers.KING_BLACK_DRAGON, CustomNpcIdentifiers.ANCIENT_KING_BLACK_DRAGON),
    ...
    HELLHOUNDS(31, 1, 75, new Tile(3200, 10071), NpcIdentifiers.HELLHOUND, NpcIdentifiers.HELLHOUND_105, NpcIdentifiers.HELLHOUND_135, NpcIdentifiers.HELLHOUND_3133, NpcIdentifiers.HELLHOUND_7256, NpcIdentifiers.HELLHOUND_7877, NpcIdentifiers.SKELETON_HELLHOUND, NpcIdentifiers.SKELETON_HELLHOUND_6387, NpcIdentifiers.CERBERUS, CustomNpcIdentifiers.KERBEROS, NpcIdentifiers.SKELETON_HELLHOUND_6613),
    ...
    BLOODVELDS(48, 50, 50, new Tile(3428, 3556, 1), 7276,NpcIdentifiers.BLOODVELD, NpcIdentifiers.BLOODVELD_485, NpcIdentifiers.BLOODVELD_486, NpcIdentifiers.BLOODVELD_487, NpcIdentifiers.BLOODVELD_3138, NpcIdentifiers.INSATIABLE_BLOODVELD, NpcIdentifiers.INSATIABLE_MUTATED_BLOODVELD),//OKUPDATE
    ...
    ANKOUS(79, 1, 40,true,false, new Tile(2983, 3755, 0), NpcIdentifiers.ANKOU, NpcIdentifiers.ANKOU_2515, NpcIdentifiers.ANKOU_2516, NpcIdentifiers.ANKOU_2517, NpcIdentifiers.ANKOU_2518, NpcIdentifiers.ANKOU_2519, NpcIdentifiers.ANKOU_6608, NpcIdentifiers.ANKOU_7257, NpcIdentifiers.ANKOU_7864, NpcIdentifiers.DARK_ANKOU),
    ...
    LIZARDMAN_SHAMAN(90, 1, 3, false,true, new Tile(1453, 3694, 0), NpcIdentifiers.LIZARDMAN, NpcIdentifiers.LIZARDMAN_6915, NpcIdentifiers.LIZARDMAN_6916, NpcIdentifiers.LIZARDMAN_6917, NpcIdentifiers.LIZARDMAN_BRUTE, NpcIdentifiers.LIZARDMAN_BRUTE_6919, NpcIdentifiers.LIZARDMAN_BRUTE_8564, NpcIdentifiers.LIZARDMAN_SHAMAN, NpcIdentifiers.LIZARDMAN_SHAMAN_6767, NpcIdentifiers.LIZARDMAN_SHAMAN_7573, NpcIdentifiers.LIZARDMAN_SHAMAN_7574, NpcIdentifiers.LIZARDMAN_SHAMAN_7744, NpcIdentifiers.LIZARDMAN_SHAMAN_7745, NpcIdentifiers.LIZARDMAN_SHAMAN_8565),
    ...
    TZTOK_JAD(97, 1, 100,false, true, new Tile(2440, 5172), NpcIdentifiers.TZTOKJAD),
    CORPOREAL_BEAST(98, 1, 100,false, true, new Tile(2969, 4382, 2), NpcIdentifiers.CORPOREAL_BEAST),
    DEMONIC_GORILLA(99, 1, 100, false,true, new Tile(3109, 3676), NpcIdentifiers.DEMONIC_GORILLA, NpcIdentifiers.DEMONIC_GORILLA_7145, NpcIdentifiers.DEMONIC_GORILLA_7146, NpcIdentifiers.DEMONIC_GORILLA_7147, NpcIdentifiers.DEMONIC_GORILLA_7148, NpcIdentifiers.DEMONIC_GORILLA_7149, NpcIdentifiers.DEMONIC_GORILLA_7152),
    ELVARG(100, 75, 3,false, true, new Tile(3338, 3902), NpcIdentifiers.ELVARG_HARD),
    EL_FUEGO(101, 1, 3, false,true, new Tile(3029, 10249), CustomNpcIdentifiers.EL_FUEGO),
    LAVA_BEAST(102, 1, 3, new Tile(3092, 3883), NpcIdentifiers.LAVA_BEAST),
    ALCHEMICAL_HYDRA(103, 95, 85, false,true, new Tile(1354, 10258), NpcIdentifiers.ALCHEMICAL_HYDRA, NpcIdentifiers.ALCHEMICAL_HYDRA_8616, NpcIdentifiers.ALCHEMICAL_HYDRA_8617, NpcIdentifiers.ALCHEMICAL_HYDRA_8618, NpcIdentifiers.ALCHEMICAL_HYDRA_8619, NpcIdentifiers.ALCHEMICAL_HYDRA_8620, NpcIdentifiers.ALCHEMICAL_HYDRA_8621, NpcIdentifiers.ALCHEMICAL_HYDRA_8622, NpcIdentifiers.ALCHEMICAL_HYDRA_8634),
    LAVA_DRAGONS(104, 1, 85,true,false, new Tile(3198, 3851), CustomNpcIdentifiers.EL_FUEGO, NpcIdentifiers.LAVA_DRAGON),
    ...
    DARK_WARRIOR(112, 1, 3, true,false,null, NpcIdentifiers.DARK_WARRIOR, NpcIdentifiers.DARK_WARRIOR_6606),
    ...
    ROGUES(116, 1, 3,true,false, new Tile(3285, 3922), NpcIdentifiers.ROGUE, NpcIdentifiers.ROGUE_6603),
    ...
    BARRELCHEST(119, 1, 100,false, true, new Tile(3287, 3884), NpcIdentifiers.BARRELCHEST_6342, CustomNpcIdentifiers.ANCIENT_BARRELCHEST),
    ...
    ABYSSAL_SIRE(121, 85, 100, false,true, null, NpcIdentifiers.ABYSSAL_SIRE, NpcIdentifiers.ABYSSAL_SIRE_5887, NpcIdentifiers.ABYSSAL_SIRE_5888, NpcIdentifiers.ABYSSAL_SIRE_5889, NpcIdentifiers.ABYSSAL_SIRE_5890, NpcIdentifiers.ABYSSAL_SIRE_5891, NpcIdentifiers.ABYSSAL_SIRE_5908),
    BARROWS(122, 1, 85,false, true, new Tile(3565, 3306), NpcIdentifiers.AHRIM_THE_BLIGHTED, NpcIdentifiers.DHAROK_THE_WRETCHED, NpcIdentifiers.GUTHAN_THE_INFESTED, NpcIdentifiers.KARIL_THE_TAINTED, NpcIdentifiers.TORAG_THE_CORRUPTED, NpcIdentifiers.VERAC_THE_DEFILED),
    CALLISTO(123, 1, 100,true, true, new Tile(3307, 3837), NpcIdentifiers.CALLISTO, CustomNpcIdentifiers.ARTIO, NpcIdentifiers.CALLISTO_6609),
    CERBERUS(124, 91, 100,false, true, new Tile(1241, 1248), NpcIdentifiers.CERBERUS, NpcIdentifiers.CERBERUS_5863, CustomNpcIdentifiers.KERBEROS ,NpcIdentifiers.CERBERUS_5866),
    CHAOS_ELEMENTAL(125, 1, 100,true, true, new Tile(3269, 3927), NpcIdentifiers.CHAOS_ELEMENTAL, NpcIdentifiers.CHAOS_ELEMENTAL_6505, CustomNpcIdentifiers.ANCIENT_CHAOS_ELEMENTAL),
    CHAOS_FANATIC(126, 1, 85,true, true, new Tile(2992, 3851), NpcIdentifiers.CHAOS_FANATIC),
    COMMANDER_ZILYANA(127, 1, 100, false,true, new Tile(2911, 5267, 0), NpcIdentifiers.COMMANDER_ZILYANA),
    CRAZY_ARCHAEOLOGIST(128, 1, 85, true,true, new Tile(2976, 3694), NpcIdentifiers.CRAZY_ARCHAEOLOGIST),
    DAGANNOTH_KINGS(129, 1, 85,false, true, null, NpcIdentifiers.DAGANNOTH_PRIME, NpcIdentifiers.DAGANNOTH_REX, NpcIdentifiers.DAGANNOTH_SUPREME),
    GENERAL_GRAARDOR(130, 1, 100,false, true, new Tile(2860, 5354, 2), NpcIdentifiers.GENERAL_GRAARDOR),
    GIANT_MOLE(131, 1, 85,false, true, new Tile(1752, 5234), NpcIdentifiers.GIANT_MOLE, NpcIdentifiers.GIANT_MOLE_6499),
    GROTESQUE_GUARDIANS(132, 75, 100,false, true, null, NpcIdentifiers.DUSK, NpcIdentifiers.DAWN),
    KRIL_TSUTSAROTH(133, 1, 100,false, true, new Tile(2925, 5336, 2), NpcIdentifiers.KRIL_TSUTSAROTH),
    KALPHITE_QUEEN(134, 1, 100,false, true, new Tile(3507, 9494, 2), NpcIdentifiers.KALPHITE_QUEEN_6501),
    KING_BLACK_DRAGON(135, 1, 85,true, true, new Tile(3016, 3849), NpcIdentifiers.KING_BLACK_DRAGON, NpcIdentifiers.KING_BLACK_DRAGON_6502, CustomNpcIdentifiers.ANCIENT_KING_BLACK_DRAGON),
    KRAKEN(136, 87, 85,false, true, new Tile(3344, 3822), NpcIdentifiers.KRAKEN),
    KREE_ARRA(137, 1, 100,false, true, new Tile(2841, 5291, 2), NpcIdentifiers.KREEARRA),
    SARACHNIS(138, 1, 3, null, NpcIdentifiers.SARACHNIS),
    SCORPIA(139, 1, 3,true, true, new Tile(3232, 3950), NpcIdentifiers.SCORPIA),
    THERMONUCLEAR_SMOKE_DEVIL(140, 93, 100,false, true, new Tile(2379, 9452), NpcIdentifiers.THERMONUCLEAR_SMOKE_DEVIL),
    VENENATIS(141, 1, 100,true, true, new Tile(3319, 3745), NpcIdentifiers.VENENATIS, NpcIdentifiers.VENENATIS_6610),
    VETION(142, 1, 100,true, true, new Tile(3239, 3783), NpcIdentifiers.VETION, NpcIdentifiers.VETION_REBORN),
    VORKATH(143, 1, 112,false, true, new Tile(2273, 4049), NpcIdentifiers.VORKATH_8061),
    ZULRAH(144, 1, 100,false, true, new Tile(2201, 3057, 0), NpcIdentifiers.ZULRAH, NpcIdentifiers.ZULRAH_2043, NpcIdentifiers.ZULRAH_2044),
    WORLD_BOSS(145, 1, 85,false, true, null, NpcIdentifiers.SKOTIZO, NpcIdentifiers.ZOMBIES_CHAMPION, NpcIdentifiers.TEKTON_7542),
    ROCK_CRAB(146, 1, 3,false, false, null, NpcIdentifiers.ROCK_CRAB),
    EXPERIMENTS(147, 1, 3,false, false, null, NpcIdentifiers.EXPERIMENT,1274,1275),

    ;

    public int uid, req, cbreq;
    public boolean bossTask;
    public boolean wildTask;
    ...
    SlayerCreature(int uid, int req, int cbreq,boolean wildTask, boolean bossTask, Tile teleportLocation, int... ids) {
        this.uid = uid;
        this.req = req;
        this.cbreq = cbreq;
        this.bossTask = bossTask;
        this.wildTask = wildTask;
        this.teleportLocation = teleportLocation;
        this.ids = ids;
    }
        ...
        if (task != null) {
            ...
            if (num > 0) {
                ...
                if (!Teleports.canTeleport(player, true, TeleportType.GENERIC)) {
                    //Method already sents block message, no need for a block message here
                    return;
                }

                //We passed the teleport requirements
                Tile tile = task.teleportLocation;//teleport tile
                if (task == WORLD_BOSS) {//World boss uses custom tile code
                ...
                if(isWilderness) {
                    ...
                    return;//Stop any code from processing
                }
