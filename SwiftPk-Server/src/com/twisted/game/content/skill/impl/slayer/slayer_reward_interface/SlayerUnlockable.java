package com.twisted.game.content.skill.impl.slayer.slayer_reward_interface;
...
public enum SlayerUnlockable {
    ...
    DOUBLE_SLAYER_POINTS(63406, new Item(SLAYER_TOME), 750, "15% more slayer points", "Gives 15% more points when" + "<br>completing any slayer task. <col=ca0d0d>(750 points)</col>"),
    ...
    KEY_OF_BOXES(63419, new Item(CustomItemIdentifiers.KEY_OF_BOXES), 250, "Key of Boxes", "Random chance of receiving the key of<br>drops. During your slayer task in the" + "<br>wilderness. Drop rate = 1/1000 <col=ca0d0d> (250 points)"),
    ...
    SLAYER_KEY_PERK(63427, new Item(SLAYER_KEY), 3500, "Slayer Collect", "Auto collect Slayer Key to inventory" + "<br><col=ca0d0d>(3500 points)"),

    WHOS_KEYS_ARE_THESE(63428, new Item(CustomItemIdentifiers.KEY_OF_BOXES), 500, "Who's keys are these", "Chance for PK's to drop a key of drops" + "<br> <col=ca0d0d>(500 points)"),
