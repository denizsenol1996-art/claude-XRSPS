...
public class Krystilia extends PacketInteraction {
    ...
    private static void taskOptions(Player player) {
        player.getDialogueManager().start(new Dialogue() {
            @Override
            protected void start(Object... parameters) {
                send(DialogueType.OPTION, DEFAULT_OPTION_TITLE, "I'd like a Wild task, please.", "Nothing");
                setPhase(0);
            }
    ...
    private static void displayOptions(Player player) {
        player.getDialogueManager().start(new Dialogue() {
            @Override
            protected void start(Object... parameters) {
                send(DialogueType.OPTION, DEFAULT_OPTION_TITLE, "I'd like a Wild task, please", "Can you cancel my current task for blood money?", "Nothing");
                setPhase(0);
            }
