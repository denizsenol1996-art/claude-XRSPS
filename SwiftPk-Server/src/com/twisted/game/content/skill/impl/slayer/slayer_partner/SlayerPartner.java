package com.twisted.game.content.skill.impl.slayer.slayer_partner;
...
import static com.twisted.util.NpcIdentifiers.THORODIN_5526;
            ...
            protected void next() {
                if (isPhase(1)) {
                    ...
                    if (partner.isPresent()) {
                        player.getPacketSender().sendMessage("You already have a slayer partner");
                        return;
                    }
