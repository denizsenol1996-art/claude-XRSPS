...
public enum FishSpotType {
    ...
    ANGLERGISH(623, 307, "You need a Fishing Rod to bait these fish.", 13431, new ArrayList<>(List.of(Fish.ANGLERFISH, Fish.KARAMBWAN)), "You cast our your line...", "You don't have any Fishing Bait left."),
