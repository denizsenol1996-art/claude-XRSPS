package com.twisted.game.content.achievements;
...
public enum Achievements {
     ...
     */
    //Misc
    COMPLETIONIST("Completionist", "Complete all Achievements besides this one.", 1, Difficulty.HARD, new Item(ONE_HUNDRED_DOLLAR_BOND), new Item(RAIDS_MYSTERY_BOX,5)),
    ...
    VOTE_FOR_US_II("Vote II", "Claim at least 250 vote points.<br>Type ::vote to support "+GameConstants.SERVER_NAME,250, Difficulty.MED, new Item(VOTE_TICKET, 50), new Item(TEN_DOLLAR_BOND)),
    VOTE_FOR_US_III("Vote III", "Claim at least 500 vote points.<br>Type ::vote to support "+GameConstants.SERVER_NAME,500, Difficulty.HARD, new Item(VOTE_TICKET, 75), new Item(TWENTY_DOLLAR_BOND)),
    ...
    MOLTEN_LOOTER_I("Molten looter I", "Open the molten chest 10 times.", 10, Difficulty.EASY, new Item(MOLTEN_KEY,2)),
    MOLTEN_LOOTER_II("Molten looter II", "Open the molten chest 50 times.", 50, Difficulty.MED, new Item(MOLTEN_KEY,5)),
    MOLTEN_LOOTER_III("Molten looter III", "Open the molten chest 100 times.", 100, Difficulty.HARD, new Item(MOLTEN_KEY,10)),
    ...
    BEAR_GRYLLS_III("Bear Grylls III", "Kill 100 Callisto.", 100, Difficulty.HARD, new Item(LEGENDARY_MYSTERY_BOX)),
    SNAKE_CHARMER_I("Snake charmer I", "Kill 10 Zulrah.", 10, Difficulty.EASY, new Item(BLOOD_MONEY, 15_000)),
    SNAKE_CHARMER_II("Snake charmer II", "Kill 75 Zulrah.", 75, Difficulty.MED, new Item(TOXIC_BLOWPIPE)),
    SNAKE_CHARMER_III("Snake charmer III", "Kill 500 Zulrah.", 500, Difficulty.HARD, new Item(MAGMA_BLOWPIPE)),
    VORKY_I("Vorky I", "Kill 50 Vorkaths.", 50, Difficulty.HARD, new Item(VORKATHS_HEAD_21907)),
    VORKY_II("Vorky II", "Kill 100 Vorkaths.", 100, Difficulty.HARD, new Item(SUPERIOR_DRAGON_BONES+1, 100), new Item(MOLTEN_MYSTERY_BOX,3)),
    VORKY_III("Vorky III", "Kill 250 Vorkaths.", 250, Difficulty.HARD, new Item(DRAGONFIRE_WARD)),
    ...
    REVENANT_HUNTER_IV("Revenant hunter IV", "Kill 10000 revenants.", 10000, Difficulty.HARD, new Item(CRAWS_BOW_C)),//, new Item(VIGGORAS_CHAINMACE), new Item(THAMMARONS_SCEPTRE)),
    ...
    SKILLER_IV("Skiller IV", "Earn level 99 in all skills on a trained account<br>with the exception of construction.", 1, Difficulty.HARD, new Item(KEY_OF_BOXES, 3), new Item(LEGENDARY_MYSTERY_BOX, 3)),
    ...
    RAIDS_GRIENDER_I("Raids Grinder I", "Complete 300 raids.", 300, Difficulty.HARD, new Item(20391, 1)),
    ...
    //Skilling
    LUMBERJACK_I("lumberjack I", "chop 100 logs.", 100, Difficulty.EASY, new Item(LUMBERJACK_HAT)),
    LUMBERJACK_II("lumberjack II", "chop 250 logs.", 250, Difficulty.EASY, new Item(LUMBERJACK_TOP)),
    LUMBERJACK_III("lumberjack III", "chop 500 logs.", 500, Difficulty.MED, new Item(LUMBERJACK_LEGS)),
    LUMBERJACK_IV("lumberjack IV", "chop 750 logs.", 750, Difficulty.HARD, new Item(LUMBERJACK_BOOTS)),
    FISHERMAN_I("fisherman I", "Catch 50 fish.", 50, Difficulty.EASY, new Item(ANGLER_HAT)),
    FISHERMAN_II("fisherman II", "Catch 100 fish.", 100, Difficulty.EASY, new Item(ANGLER_TOP)),
    FISHERMAN_III("fisherman III", "Catch 200 fish.", 200, Difficulty.MED, new Item(ANGLER_WADERS)),
    FISHERMAN_IV("fisherman IV", "Catch 400 fish.", 400, Difficulty.HARD, new Item(ANGLER_BOOTS)),
    MINER_I("miner I", "mine 100 ore.", 100, Difficulty.EASY, new Item(PROSPECTOR_HELMET)),
    MINER_II("miner II", "mine 250 ore.", 250, Difficulty.EASY, new Item(PROSPECTOR_JACKET)),
    MINER_III("miner III", "mine 500 ore.", 500, Difficulty.MED, new Item(PROSPECTOR_LEGS)),
    MINER_IV("miner IV", "mine 750 ore.", 750, Difficulty.HARD, new Item(PROSPECTOR_BOOTS)),
    ...
    SLAYER_I("Slayer I", "Complete 25 slayer tasks.", 25, Difficulty.EASY, new Item(BLOOD_MONEY, 25_000), new Item(LEGENDARY_MYSTERY_BOX, 1)),
    SLAYER_II("Slayer II", "Complete 50 slayer tasks.", 50, Difficulty.MED, new Item(BLOOD_MONEY, 50_000), new Item(KEY_OF_BOXES, 1)),
    SLAYER_III("Slayer III", "Complete 75 slayer tasks.", 75, Difficulty.MED, new Item(BLOOD_MONEY, 125_000), new Item(LEGENDARY_MYSTERY_BOX, 1)),
    SLAYER_IV("Slayer IV", "Complete 150 slayer tasks.", 150, Difficulty.HARD, new Item(BLOOD_MONEY, 500_000), new Item(LEGENDARY_MYSTERY_BOX, 2)),
