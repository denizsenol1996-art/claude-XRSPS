...
//    public static final int REFERRAL_NPC = SHURA;
...
//            setPhase(2);
    //       } else if(isPhase(2)) {
    //         send(DialogueType.NPC_STATEMENT, REFERRAL_NPC, Expression.DEFAULT, "The new player will be rewarded as well.", "Imagine not being able to fill in your referrer,", "you can always use the '::refer' command in-game", "<col=FF0000>BE AWARE! You can only refer once!</col>");
//    setPhase(3);
//} else if(isPhase(3)) {
