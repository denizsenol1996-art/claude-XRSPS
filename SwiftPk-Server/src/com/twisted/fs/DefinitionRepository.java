...
public class DefinitionRepository {
    ...
    private final Object2ObjectArrayMap<Class<? extends Definition>, Definition[]> definitionMaps = new Object2ObjectArrayMap<>();
    ...
    public void load(DataStore store, boolean lazy) {
        ...
        logger.info("Loaded {} Animation definitions.", numAnims);
