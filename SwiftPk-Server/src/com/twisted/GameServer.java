...
import com.twisted.db.DatabaseService;
import com.twisted.db.DatabaseServiceBuilder;
import com.twisted.fs.DefinitionRepository;
import com.twisted.game.GameConstants;
import com.twisted.game.GameEngine;
import com.twisted.game.service.AutoBackup;
...
import com.twisted.test.generic.PlayerProfileVerf;
import com.twisted.util.DiscordWebhook;
import com.twisted.util.flood.Flooder;
...
public class GameServer {
    ...
    static {
        ...
        if (properties().enableDiscordLogging) {
            ...
            clanChatWebHook = new DiscordWebhook(properties().clanChatWebHookUrl);//o2
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(() -> {
                try {
                    GameEngine.getInstance().addSyncTask(() -> {
                        ...
                        final MobList<Player> onlinePlayerCopy = World.getWorld().getPlayers();
                        for (final Player player : onlinePlayerCopy) {
                        ...
                        AutoBackup.waitUntilCompletion();
                    });
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public static DiscordWebhook getClanChatWebHook() {//o2
        return clanChatWebHook;
    }

    private static DiscordWebhook clanChatWebHook;//o2
